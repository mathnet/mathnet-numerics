namespace Geometry
{
    ...
    public static class RotationMatrices
    {
        ...
        public static Matrix<double> RotationAroundArbitraryVector(UnitVector3D aboutVector, Angle angle)
        {
            ...
            var r1 = DenseMatrix.CreateIdentity(3).Multiply(Math.Cos(angle));
            var r2 = crossproductMatrix.Multiply(Math.Sin(angle));
            var r3 = unitTensorProduct.Multiply(1 - Math.Cos(angle));
