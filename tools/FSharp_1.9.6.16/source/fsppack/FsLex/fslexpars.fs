...
# 245 "fslexpars.fs"
        (fun (parseState : Internal.Utilities.Text.Parsing.IParseState) ->
            let _1 = (let data = parseState.GetInput(1) in (Microsoft.FSharp.Core.Operators.unbox data : Fslexast.Spec)) in
...
# 268 "fslexpars.fs"
        (fun (parseState : Internal.Utilities.Text.Parsing.IParseState) ->
            let _1 = (let data = parseState.GetInput(1) in (Microsoft.FSharp.Core.Operators.unbox data : Fslexast.Code)) in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 24 "fslexpars.fsy"
...
# 425 "fslexpars.fs"
        (fun (parseState : Internal.Utilities.Text.Parsing.IParseState) ->
            ...
            let _2 = (let data = parseState.GetInput(2) in (Microsoft.FSharp.Core.Operators.unbox data : Fslexast.Code)) in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 32 "fslexpars.fsy"
        ...
        (fun (parseState : Internal.Utilities.Text.Parsing.IParseState) ->
            ...
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 51 "fslexpars.fsy"
                      Set.of_seq [ for c in _1 .. _3 -> EncodeChar c ] 
                   )
# 51 "fslexpars.fsy"
                 : 'charset));
# 614 "fslexpars.fs"
...
let spec lexer lexbuf : Fslexast.Spec =
