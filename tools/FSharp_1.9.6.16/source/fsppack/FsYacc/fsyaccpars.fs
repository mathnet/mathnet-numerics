...
type token = 
  ...
  | EOF
  | ERROR
  | HEADER of (Fsyaccast.Code)
  | CODE of (Fsyaccast.Code)
  | IDENT of (string)
...
# 213 "fsyaccpars.fs"
        (fun (parseState : Internal.Utilities.Text.Parsing.IParseState) ->
            let _1 = (let data = parseState.GetInput(1) in (Microsoft.FSharp.Core.Operators.unbox data : Fsyaccast.ParserSpec)) in
        ...
        (fun (parseState : Internal.Utilities.Text.Parsing.IParseState) ->
            ...
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 22 "fsyaccpars.fsy"
                      List.fold_right (fun f x -> f x) _2 { Header=_1;Tokens=[];Types=[];Associativities=[];StartSymbols=[];Rules=_4 } 
                   )
# 22 "fsyaccpars.fsy"
                 : Fsyaccast.ParserSpec));
# 235 "fsyaccpars.fs"
        (fun (parseState : Internal.Utilities.Text.Parsing.IParseState) ->
            let _1 = (let data = parseState.GetInput(1) in (Microsoft.FSharp.Core.Operators.unbox data : Fsyaccast.Code)) in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 26 "fsyaccpars.fsy"
...
# 468 "fsyaccpars.fs"
        (fun (parseState : Internal.Utilities.Text.Parsing.IParseState) ->
            ...
            let _3 = (let data = parseState.GetInput(3) in (Microsoft.FSharp.Core.Operators.unbox data : Fsyaccast.Code)) in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 48 "fsyaccpars.fsy"
...
let spec lexer lexbuf : Fsyaccast.ParserSpec =
