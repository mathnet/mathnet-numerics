...
module LinearAlgebraManaged = 
    ...
    let SolveTriangularLinearSystem K v isLower = (SolveTriangularLinearSystems K (Matrix.of_vector v) isLower).Column 0
    ...
    let LU A =
        ...
        (((*P.Length,*)Permutation.of_array P),L + Matrix.identity nA,U)
